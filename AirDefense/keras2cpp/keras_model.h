...
public:
  ...
  virtual std::vector<std::vector<float> > const & get_2d() const { throw "not implemented"; };
  virtual std::vector<std::vector<std::vector<float> > > const & get_3d() const { throw "not implemented"; };
  virtual void set_data(std::vector<std::vector<std::vector<float> > > const &) {};
  virtual void set_data(std::vector<std::vector<float> > const &) {};
...
public:
  std::vector< std::vector<float> > const & get_2d() const { return data; };
  virtual void set_data(std::vector<std::vector<float> > const & d) { data = d; };
  size_t get_data_dim(void) const { return 2; }

  void show_name() {
    std::cout << "DataChunk1D " << data.size() << "x" << data[0].size() << std::endl;
  }
  ...
  std::vector<std::vector<float> > data; // depth, cols
